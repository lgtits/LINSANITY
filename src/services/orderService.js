...
//   items: [{ itemId, menuItemId, menuItemName, price, qty }], total }
...
const mockOrders = [
  // ── 2026-06-02 阿忠便當 (batch_d1) ──────────────────────────────
  {
    ...
    items: [{ itemId: 'i_d1', menuItemId: 'm1', menuItemName: '排骨便當', price: 70, qty: 1 }],
    total: 70
  },
  {
    ...
    items: [{ itemId: 'i_d2', menuItemId: 'm2', menuItemName: '雞腿便當', price: 80, qty: 1 }],
    total: 80
  },
  {
    ...
    items: [{ itemId: 'i_d3', menuItemId: 'm4', menuItemName: '素食便當', price: 65, qty: 1 }],
    total: 65
  },
  {
    ...
    items: [
      { itemId: 'i_d5a', menuItemId: 'm2', menuItemName: '雞腿便當', price: 80, qty: 1 },
      { itemId: 'i_d5b', menuItemId: 'm3', menuItemName: '控肉便當', price: 75, qty: 1 }
    ],
    total: 155
  },
  // ── 2026-06-02 香香自助餐 (batch_d2) ────────────────────────────
  {
    ...
    items: [{ itemId: 'i_d4', menuItemId: 'm7', menuItemName: '四菜一湯', price: 90, qty: 1 }],
    total: 90
  },
  // ── 2026-06-03 阿忠便當 (batch_d3) ──────────────────────────────
  {
    ...
    restaurantId: 'r1', restaurantName: '阿忠便當',
    studentId: 's1', studentName: '王小明', grade: 3,
    items: [{ itemId: 'i_d6', menuItemId: 'm2', menuItemName: '雞腿便當', price: 80, qty: 1 }],
    total: 80
  },
  {
    ...
    items: [{ itemId: 'i_d9', menuItemId: 'm3', menuItemName: '控肉便當', price: 75, qty: 1 }],
    total: 75
  },
  {
    ...
    restaurantId: 'r1', restaurantName: '阿忠便當',
    studentId: 's6', studentName: '吳俊賢', grade: 6,
    items: [{ itemId: 'i_d11', menuItemId: 'm2', menuItemName: '雞腿便當', price: 80, qty: 1 }],
    total: 80
  },
  // ── 2026-06-03 香香自助餐 (batch_d4) ────────────────────────────
  {
    ...
    restaurantId: 'r2', restaurantName: '香香自助餐',
    studentId: 's2', studentName: '李小華', grade: 4,
    items: [{ itemId: 'i_d7', menuItemId: 'm7', menuItemName: '四菜一湯', price: 90, qty: 1 }],
    total: 90
  },
  {
    ...
    restaurantId: 'r2', restaurantName: '香香自助餐',
    studentId: 's3', studentName: '陳美玲', grade: 3,
    items: [{ itemId: 'i_d8', menuItemId: 'm9', menuItemName: '素食套餐', price: 75, qty: 1 }],
    total: 75
  },
  {
    ...
    restaurantId: 'r2', restaurantName: '香香自助餐',
    studentId: 's5', studentName: '林佳芬', grade: 2,
    items: [{ itemId: 'i_d10', menuItemId: 'm7', menuItemName: '四菜一湯', price: 90, qty: 1 }],
    total: 90
  }
]
